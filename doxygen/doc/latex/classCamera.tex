...
\index{Camera@{Camera}!Camera@{Camera}}
\subsubsection[{Camera(string intrinsic\+File\+Path)}]{\setlength{\rightskip}{0pt plus 5cm}Camera\+::\+Camera (
...
\subsubsection[{calibrate(vector$<$ string $>$ image\+List, int board\+Width, int board\+Height)}]{\setlength{\rightskip}{0pt plus 5cm}void Camera\+::calibrate (
\begin{DoxyParamCaption}
...
\subsubsection[{save\+Calibration(string intrinsic\+File\+Path)}]{\setlength{\rightskip}{0pt plus 5cm}bool Camera\+::save\+Calibration (
\begin{DoxyParamCaption}
\item[{string}]{intrinsic\+File\+Path}
\end{DoxyParamCaption}
...
\subsubsection[{set\+Camera\+Matrix(\+Mat \&\+K)}]{\setlength{\rightskip}{0pt plus 5cm}void Camera\+::set\+Camera\+Matrix (
\begin{DoxyParamCaption}
\item[{Mat \&}]{K}
\end{DoxyParamCaption}
...
\subsubsection[{set\+Dist\+Coefficients(\+Mat \&\+Dist)}]{\setlength{\rightskip}{0pt plus 5cm}void Camera\+::set\+Dist\+Coefficients (
\begin{DoxyParamCaption}
\item[{Mat \&}]{Dist}
\end{DoxyParamCaption}
...
\subsubsection[{undistort\+Image(\+Mat image)}]{\setlength{\rightskip}{0pt plus 5cm}Mat Camera\+::undistort\+Image (
\begin{DoxyParamCaption}
\item[{Mat}]{image}
\end{DoxyParamCaption}
